...
// folowing values are shared and a max of 10.000 call are allowed per day
#define GOOGLE_CLIENT_ID "288559267245-qn8j5ve87lk9u1hjbj0f5iugdg4nolaa.apps.googleusercontent.com"
#define GOOGLE_CLIENT_SECRET "ebx6VmjJ76_Xv6CeiPb1Nibs"
...
static gchar *gphoto_get_user_refresh_token(GphotoContext *ctx)
{
  ...
  params = dt_util_dstrcat(params, "refresh_token=%s&client_id=" GOOGLE_CLIENT_ID
...
static int gphoto_get_user_auth_token(dt_storage_gphoto_gui_data_t *ui)
{
  ...
  gchar *params = NULL;
  params = dt_util_dstrcat(params, "code=%s&client_id=" GOOGLE_CLIENT_ID "&client_secret=" GOOGLE_CLIENT_SECRET
                                   "&redirect_uri=" GOOGLE_URI "&grant_type=authorization_code", token);
